        ...
        <Layout title="Home" description="Programming Cheatsheets and Project Guides">
            <main className={styles.main}>
                ...
                <section className={styles.hero}>
                    ...
                    <Link className={styles.cta} to="/docs/frontend">
                        Start Learning
                    </Link>
                </section>
                ...
                <section className={styles.cards}>
                    <Link className={`${styles.card} ${styles.frontend}`} to="/docs/frontend">
                        <FaReact size={40} />
                        <h2>Frontend</h2>
                        <p>React, Next.js, TypeScript — all frontend cheatsheets</p>
                    </Link>

                    <Link className={`${styles.card} ${styles.backend}`} to="/docs/backend">
                        <FaServer size={40} />
                        <h2>Backend</h2>
                        <p>Node.js, ExpressJS, PostgreSQL, Symfony, API Platform</p>
                    </Link>

                    <Link className={`${styles.card} ${styles.projects}`} to="/docs/projects">
